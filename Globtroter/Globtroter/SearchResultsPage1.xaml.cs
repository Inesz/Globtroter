...
namespace Globtroter
{
    ...
    public sealed partial class SearchResultsPage1 : Globtroter.Common.LayoutAwarePage
    {
        ...
        /// </summary>
        private sealed class Filter : Globtroter.Common.BindableBase
        {
...
namespace Globtroter
{
    ...
    public sealed partial class SearchResultsPage1 : Globtroter.Common.LayoutAwarePage
    {
        ...
        protected override void LoadState(Object navigationParameter, Dictionary<String, Object> pageState)
        {
            ...
            results = myApp.Subgroups.Where(sgr => sgr.Name.StartsWith(queryText, StringComparison.CurrentCultureIgnoreCase)).ToList();
