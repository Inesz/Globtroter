...
namespace Globtroter.Data
{
    ...
    public abstract class SampleDataCommon : Globtroter.Common.BindableBase
    {
    ...
    public class SampleDataGroup : SampleDataCommon
    {
        ...
        {
            // Provides a subset of the full items collection to bind to from a GalleryGroups
     ...
     public sealed class SampleDataSource
     {
         ...
         public SampleDataSource()
         {
             ...
             group6.Items.Add(new SampleDataItem("Group-6-Item-7",
                     ...
                     ITEM_CONTENT,
                     group6));
             group6.Items.Add(new SampleDataItem("Group-6-Item-8", "Item Title: 8", "Item Subtitle: 8", "Assets/LightGray.png",
                     "Item Description: Pellentesque porta, mauris quis interdum vehicula, urna sapien ultrices velit, nec venenatis dui odio in augue. Cras posuere, enim a cursus convallis, neque turpis malesuada erat, ut adipiscing neque tortor ac erat.",
                     ITEM_CONTENT, group6));
